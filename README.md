...
> Проект выполнен в рамках дополнительной образовательной программы  
> «Основы программирования на языке Go»  
> [Посмотреть сертификат (PDF)](certificate_Yandex_Go.pdf)

> А также в ветках calc-v1 и calc-v2 находятся предыдущие версии проекта, которые были сделаны в рамках курса.
